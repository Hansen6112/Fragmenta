...
const ITEM_DEFS = {
  ...
  "a legion command scutum with a preserved standard-hook": { slot: "offhand", tier: 4, bonuses: { def: 4 }, effects: ["brace", "tactical_memory"], source: "contract", set: "Legion" },
  ...
  "a legion strategist's crested helm": { slot: "helmet", tier: 4, bonuses: { def: 2, knowledge: 2 }, effects: ["tactical_memory"], source: "contract", set: "Legion" },
  ...
  "a legion officer's mail coat": { slot: "chest", tier: 2, bonuses: { def: 2 }, effects: ["stalwart"], source: "job", set: "Legion" },
  ...
  "legion relay boots bearing official seals": { slot: "boots", tier: 4, bonuses: { knowledge: 4 }, effects: ["trailwise", "ambush_sense"], source: "contract", set: "Legion" },
  ...
  "a legion dueling ring": { slot: "rings", tier: 2, bonuses: { atk: 2 }, effects: ["feinting_edge"], source: "job", set: "Legion" },
  ...
  "a legion scout's grey cloak": { slot: "cloak", tier: 2, bonuses: { def: 1, knowledge: 1 }, effects: ["ambush_sense"], source: "job", set: "Legion" },
