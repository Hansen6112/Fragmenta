...
const EFFECT_DEFS = {
  ...
  stones_patience: { name: "Stone's Patience", category: "regalia", description: "Whenever you do not move first in a combat round, your next attack deals 30% additional damage. A faster enemy (see the Speed stat) occasionally strikes before your chosen action resolves — whenever that happens this round, your next hit carries this bonus." },
  ...
  unhurried_step: { name: "Unhurried Step", category: "regalia", description: "Enemy Haste, Speed, or Turn-order manipulation has no effect on you. A faster enemy (see the Speed stat) can otherwise strike pre-emptively before your chosen action resolves — this effect flatly forces that chance to zero, regardless of how much faster the enemy is." },
